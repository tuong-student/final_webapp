            ...
            <div class="main_content">
                <ul class="items">
                    ...
                    <c:forEach var="user" items="${user_list}">
                        <li class="item">
                            <form class="text_container" action="DeleteServlet" method="post">
                            <input type="hidden" name="action" value="deleteUser">
                            <input type="hidden" name="email" value="${user.getemail()}">
                            <div class="text_container">
                                <div class="item_text">${user.getID()}</div>
                                <div class="item_text">${user.getname()}</div>
                                <div class="item_text">${user.getemail()}</div>
