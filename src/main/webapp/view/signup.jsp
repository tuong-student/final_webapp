...
<body>
    <div class="wrapper">
        <div class="container">
            <div class="header">
                <h2 class="header__title">Signup Form</h2>
            ...
            <form action="LoginController" class="form">
                ...
                <div class="form__input">
                    ...
                    <i class="form__icon"><img src="assets/user.svg" alt=""></i>
                    <input id="name" type="text" name="name" placeholder="Full Name" required autocomplete="off" class="field">
                </div>
                <div class="form__input">
